...
const Login = () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-muted/50 px-8 py-8 lg:px-12">
      ...
      <div className="w-full max-w-[1240px] rounded-3xl shadow-[0_8px_40px_-12px_rgba(0,0,0,0.15)] overflow-hidden">
        <div className="flex min-h-[600px]">
          {/* Left Side - Login Form (Softened Dark) */}
          <div 
            className="flex w-full lg:w-1/2 flex-col justify-between p-8 lg:p-12"
            style={{ 
          ...
          >
            {/* Logo */}
            <div>
              <h1 className="text-2xl font-bold text-slate-100">Clstr</h1>
            </div>
              ...
              <div className="w-full space-y-8">
                ...
                <div className="space-y-3">
                  <button
                    ...
                    className="flex items-center justify-center gap-3 px-6 py-4 rounded-xl bg-white/10 hover:bg-white/15 transition-colors duration-200 border border-white/10"
                  >
                    <svg
                      width="20"
                      height="20"
                    ...
                    <span className="text-slate-100 font-medium">Continue with Google</span>
                  </button>
