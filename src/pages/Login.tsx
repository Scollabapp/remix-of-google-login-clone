...
const Login = () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-muted/50 px-8 py-8 lg:px-12">
      ...
      <div className="lg:hidden fixed inset-0 flex flex-col">
        ...
        <div className="absolute bottom-0 left-0 right-0 px-4 pb-8">
          <div className="bg-white/75 backdrop-blur-xl border border-white/30 rounded-3xl p-8 shadow-[0_8px_40px_-12px_rgba(0,0,0,0.15)]">
            {/* Logo */}
            <h1 className="text-xl font-bold text-foreground mb-6">Clstr</h1>
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-6 py-4 rounded-full bg-foreground hover:bg-foreground/90 transition-colors duration-200"
            >
              <svg
                width="20"
                height="20"
      ...
      <div className="hidden lg:block w-full max-w-[1240px] bg-foreground rounded-3xl shadow-[0_8px_40px_-12px_rgba(0,0,0,0.15)] overflow-hidden">
